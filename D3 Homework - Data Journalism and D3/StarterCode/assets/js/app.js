...
xText.append("text").attr("y", -26).attr("date-name", "poverty").attr("data-axis", "x").attr("class", "aText active x").text("In Poverty (%)");
...
yText.append("text").attr("y", -26).attr("date-name", "obesity").attr("data-axis", "y").attr("class", "aText active y").text("Obese (%)");
...
function visualize(theData) {
    ...
    var toolTip = d3.tip().attr("class", "d3-tip").offset([40, -60]).html(function(d) {
        var theX;
        ...
        if  (curX === "poverty") {
            ...
            theX = "<div>" + ": " + parseFloat(d[curX]).toLocaleString("en") + "</div>";
        }
    ...
    d3.selectAll(".aText").on("click", function() {
        if (self.classed("inactive")) {
            ...
            if (axis === "x") {
                ...
                d3.selectAl;("circle").each(function() {
                ...
                svg.select(".yAxis").transition().duration(350).call(yAxis);
